    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 flex flex-col gap-4 px-4 py-6 max-w-md mx-auto w-full">
        ...
        <Link
          ...
          className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-center gap-4 hover:border-orange-300 hover:shadow transition"
        >
          <span className="text-4xl">🕒</span>
          <div className="flex-1">
            <h2 className="text-gray-800 font-semibold">Historial de cambios</h2>
            <p className="text-gray-500 text-sm mt-0.5">
              Ediciones y eliminaciones administrativas de solicitudes.
            </p>
          </div>
          <span className="text-gray-400 text-xl">›</span>
        </Link>
